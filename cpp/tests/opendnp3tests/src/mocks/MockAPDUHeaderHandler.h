...
public:
	...
	virtual IINField ProcessHeader(const RangeHeader& header, const ICollection<Indexed<Devicedata>>& values) override final
	{
		return ProcessAny(header, values, DeviceInfo);
